...
**ToDo** Change the ref designators no the Schematic to reflect my current ones as shown below
...
| U7 | 1 | LPS22HH | Barometric sensor | STMicroelectronics | LPS22HHTR | HLGA-10L |  | Edge (vent) | Vent/keepout |
| U8 | 1 | SHTC3 | Temp/RH sensor | Sensirion | SHTC3 | DFN-4 |  | Edge (vent) | On **VDD_SENS** |
...
- Create **Variant `Proto_A`** and set **Not Fitted**: `L1A (10 nH)`, `D_RF`, `C_RF*/L_RF*`, `J2`, `FL_USB`, `R_USB_DP/DM`, `R_SCL_SER/R_SDA_SER`, `R_GS`, `R_CC_Spare*`, `C_Y1*`.
