...
- **Power:** Single-cell Li-Po, **TI BQ25180** ultra-low-Iq charger with **ship-mode** (USB-C sink), **TPS7A02-3.3** LDO
...
- **Power_Batt_Charge_LDO.SchDoc** — Single‑cell Li‑Po via **TI BQ25180** (USB‑C sink, ship‑mode), **TPS22910A** gated sensor rail (**VDD_SENS**), **TPS7A02‑3V3** LDO, thermistor input, test pads.
...
- Replaced **BQ24074** with **TI BQ25180** across Highlights, Power sheet description, and **Datasheets**.  
- Please drop the BQ25180 PDF into `Docs/Datasheets/TI_BQ25180_Datasheet.pdf` (and you can remove the old BQ24074 file if you like).
